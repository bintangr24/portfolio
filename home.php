            ...
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                        <div class="text-uppercase">Electrical · Mechatronics · Control</div>
                    </div>
                    <h1 class="display-3 fw-bolder"><span class="text-gradient d-inline">Bintang Ramadhan</span></h1>
                    <div class="fs-3 fw-light text-muted mb-5">
                        Karawang, West Java
                    </div>
            ...
            <div class="col-xxl-7">
                ...
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile bg-gradient-primary-to-secondary">
                        ...
                        <img class="profile-img rounded-5 mb-2" src="./home_files/240807103401.png" alt="...">
                        <div class="dots-1">
                            <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is Bintang Ramadhan and I have a Bachelor's degree in
                            Electrical Engineering.</p>
                        <p class="text-muted"></p>
                        <p class="MsoNormal" style="text-align:justify"><span lang="EN-US">Graduate in
                                Electrical Engineering with a specialization in Mechatronic Control. Actively
                                participated in various activities such as student organizations, independent
                                studies, research, internships, competitions, and workshops. Interested in
                                systems and control mechatronics, web development, and machine learning.</span><span
                                lang="EN-US">
                                <o:p></o:p>
                            </span></p>
                        <p></p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" target="_blank" href="https://instagram.com/bintangr_24"><i
                                    class="bi bi-instagram"></i></a>
                            <a class="text-gradient" target="_blank"
                                href="https://www.linkedin.com/in/bintangramadhan24"><i class="bi bi-linkedin"></i></a>
                            <a class="text-gradient" href="http://127.0.0.1:8000/#!"><i class="bi bi-github"></i></a>
                            <a class="text-gradient" target="_blank" href="mailto:ramadhanbintang94@gmail.com"><i
